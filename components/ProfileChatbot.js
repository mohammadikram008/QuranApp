        ...
        <View style={{marginBottom:"20%"}}>
            ...
            {showAll==true?(
              <>
                <View>
                  <Text style={{fontSize:18,fontWeight:'bold'}}>Name: {username}</Text>
                  {/* <Text style={{fontSize:18,fontWeight:'bold'}}>Local Storage Name: {getData("Username")}</Text> */}
                </View>
                <View>
                  <Text style={{fontSize:18,fontWeight:'bold'}}>Sect: {sect}</Text>
                  {/* <Text style={{fontSize:18,fontWeight:'bold'}}>Local Storage Sect: {getData("Sect")}</Text> */}
                </View>
                <View>
                  <Text style={{fontSize:18,fontWeight:'bold'}}>Gender: {gender}</Text>
                  {/* <Text style={{fontSize:18,fontWeight:'bold'}}>Local Storage Gender: {getData("Gender")}</Text> */}
                </View>
              </>
